...
Banned: *No*\n
Health: *${healt}*
Armor: *${armor == 0 ? 'Tidak Punya' : '' || armor == 1 ? 'Leather Armor' : '' || armor == 2 ? 'Iron Armor' : '' || armor == 3 ? 'Gold Armor' : '' || armor == 4 ? 'Diamond Armor' : '' || armor == 5 ? 'Netherite Armor' : '' || armor == 99999 ? 'Hacker Armor' : ''}*\n
Money: *${money}*
Level: *${level}*
Exp: *${exp}*\n
*Inventory*
...
Potion: *${potion}*
Sampah: *${sampah}*
Total inv: *${diamond + potion + sampah}* item\n
*Crate*
Common: *${common}*
Uncommon: *${uncommon}*
Mythic: *${mythic}*
...
handler.tags = ['rpg']
handler.command = /^(inv|inventory|bal|level|money)$/i
